...
const BBOX_WEST  = -92.200;   // Duluth MN — Lake Superior west shore
...
const CORRIDOR_CITIES = [
  ...
  // ── Florida ──────────────────────────────────────────────────────────────
  {
    ...
    region: 'coastal',
    soil:   'Myakka fine sand (Coastal Plain Entisol, seasonally saturated)',
    zone:   '9a',
    note:   'Where the St. Johns — one of the few North-flowing rivers in the US — meets the Atlantic. The largest city by land area in the contiguous US sits astride the fall line transition from Piedmont sands to tidal floodplain.',
  },
  {
    name:   'Tallahassee',
    state:  'FL',
    ...
    region: 'gulfCoastal',
    soil:   'Orangeburg loamy sand (Red Hills Ultisol)',
    zone:   '8b',
    note:   'Florida\'s capital sits on the Red Hills — a relict Piedmont remnant of ancient red clay soils pushed south by Appalachian erosion. The longleaf pine savannas here shelter one of the highest concentrations of endemic species in North America.',
  },
  {
    name:   'Gainesville',
    state:  'FL',
    ...
    region: 'gulfCoastal',
    soil:   'Arredondo fine sand (Coastal Plain Spodosol, karst terrain)',
    zone:   '9a',
    note:   'University of Florida sits above the Floridan Aquifer — the largest artesian aquifer system in the world. The Santa Fe River disappears entirely into a sinkhole and re-emerges three miles later as a first-magnitude spring, one of hundreds in the region.',
  },
  {
    name:   'Orlando',
    state:  'FL',
    lat:     28.538,
    lon:    -81.381,
    river:  'St. Johns River headwaters',
    region: 'coastal',
    soil:   'Myakka fine sand (Spodosol — high spodic horizon, seasonal water table)',
    zone:   '9b',
    note:   'The Central Florida Ridge rises just 100 feet above the surrounding flatwoods — enough to create a distinct scrub ecosystem found nowhere else on Earth. The ancient Lake Wales Ridge is one of the oldest continuously dry land surfaces in Florida.',
  },
  {
    name:   'Tampa',
    state:  'FL',
    ...
    region: 'coastal',
    soil:   'Riviera fine sand (low-lying Entisol, marl and shell over limestone)',
    zone:   '10a',
    note:   'Tampa Bay is the largest open-water estuary in Florida — the Hillsborough River\'s tannin-stained waters drop from the Brooksville Ridge into the bay. The bay\'s seagrass beds, once nearly destroyed by dredge-and-fill, have been largely restored through one of the most successful estuary recovery programs in US history.',
  },
  {
    ...
    river:  'New River',
    region: 'coastal',
    soil:   'Margate fine sand (Histosol peat over Miami limestone oolite)',
    zone:   '10b',
    note:   '"The Venice of America" — built on drained Everglades peat over porous oolitic limestone. South Florida\'s fresh water supply is entirely dependent on rainfall recharge through the porous Biscayne Aquifer; the Everglades function as the aquifer\'s natural filter.',
  },
  {
    name:   'Miami',
    state:  'FL',
    ...
    river:  'Miami River',
    region: 'coastal',
    soil:   'Rockdale gravelly loamy sand (Miami limestone oolite — shallow to bedrock)',
    zone:   '10b',
    note:   'Built directly on Miami limestone — porous oolitic rock formed just 120,000 years ago during the last interglacial sea level highstand. Only 8 feet of elevation separates downtown from the ocean; every garden here contends with limestone bedrock inches below the surface and salt spray.',
  },
  // ── Louisiana ────────────────────────────────────────────────────────────
  {
    name:   'Baton Rouge',
    ...
    region: 'gulfCoastal',
    soil:   'Commerce silt loam (Holocene Mississippi River alluvium)',
    zone:   '9a',
    note:   'The last natural high ground before the Mississippi fans into its delta — Baton Rouge means "red stick," a boundary marker between Houma and Bayou Goula tribal territories. The city sits on a Pleistocene bluff that elevates it above the floodplain; downstream from here, New Orleans required levees from its founding.',
  },
  {
    name:   'New Orleans',
    state:  'LA',
    ...
    river:  'Mississippi River',
    region: 'gulfCoastal',
    soil:   'Harahan silty clay (deltaic alluvium, much of city below sea level)',
    zone:   '9b',
    note:   'Built on a natural levee of the Mississippi at its delta mouth — most of the city sits below sea level, sustained by a 350-mile levee system. The batture soils along the river are among the most fertile in North America; the creole cottage garden tradition evolved to maximize production in hot, humid conditions on rich alluvial soil.',
  },
  // ── Mississippi ──────────────────────────────────────────────────────────
  {
    name:   'Jackson',
    ...
    river:  'Pearl River',
    region: 'interiorLowlands',
    soil:   'Providence silt loam (Loess Hills Ultisol — Natchez Loess)',
    zone:   '8a',
    note:   'Mississippi\'s capital sits on the Loess Hills — ancient windblown silt deposits 30–90 feet thick that create the most fertile and erodible soils in the state. The Pearl River\'s floodplain below Jackson contains one of the largest bottomland hardwood forests remaining in the mid-South.',
  },
  {
    name:   'Biloxi',
    state:  'MS',
    lat:     30.396,
    lon:    -88.885,
    river:  'Tchoutacabouffa River',
    region: 'gulfCoastal',
    soil:   'Ruston loamy sand (Coastal Plain Ultisol — terrace sediment)',
    zone:   '9a',
    note:   'On the Mississippi Sound between Mobile Bay and the Mississippi River delta — one of the oldest European settlements in the Mississippi Valley (1699). The coastal marshes, barrier islands, and longleaf pine flatwoods once formed a nearly continuous corridor from Florida to Texas.',
  },
  // ── Alabama (additional) ─────────────────────────────────────────────────
  {
    name:   'Birmingham',
    ...
    region: 'valleyRidge',
    soil:   'Wynnville silty clay loam (red shale-derived Ultisol)',
    zone:   '7b',
    note:   'Built 1871 at the intersection of coal, iron ore, and limestone deposits that made it the only city in the western hemisphere where all three raw materials for steel production occur within miles of each other. The Jones Valley nestles between Red Mountain (iron ore) and Shades Mountain (coal) in the Valley and Ridge province.',
  },
  {
    name:   'Huntsville',
    state:  'AL',
    ...
    river:  'Tennessee River',
    region: 'valleyRidge',
    soil:   'Decatur silty clay loam (limestone-derived Alfisol — Tennessee Valley)',
    zone:   '7a',
    note:   'In the Tennessee Valley at the foot of the Cumberland Plateau — Big Spring, one of the largest springs in Alabama, flows from the base of Monte Sano Mountain and sustained Native American settlement for thousands of years. NASA\'s Marshall Space Flight Center makes Huntsville the "Rocket City."',
  },
  // ── Georgia (additional) ─────────────────────────────────────────────────
  {
    name:   'Atlanta',
    ...
    river:  'Chattahoochee River',
    region: 'piedmont',
    soil:   'Cecil clay loam (Piedmont Ultisol — deeply weathered granite-gneiss)',
    zone:   '8a',
    note:   'Founded 1837 as the railroad terminus at the Eastern Continental Divide — rainwater falling just east of here flows to the Atlantic; just west, to the Gulf. At 1,050 feet elevation, Atlanta sits 700 feet above the surrounding Piedmont plain on a granite upland that divides the Chattahoochee, Flint, and Ocmulgee drainages.',
  },
  // ── North Carolina (additional) ──────────────────────────────────────────
  {
    ...
    region: 'coastal',
    soil:   'Goldsboro sandy loam (Coastal Plain Ultisol)',
    zone:   '8a',
    note:   'At the mouth of the Cape Fear River — the only North Carolina river with a direct outlet to the Atlantic without passing through a sound. Home to the largest population of Venus flytraps in the world; the carnivorous plant evolved in the nitrogen-poor longleaf pine savannas within a 60-mile radius of Wilmington.',
  },
  // ── Pennsylvania (additional) ─────────────────────────────────────────────
  {
    ...
    lat:     40.440,
    lon:    -80.002,
    river:  'Ohio River (Allegheny & Monongahela confluence)',
    region: 'valleyRidge',
    soil:   'Gilpin channery silt loam (Appalachian Plateau shale and sandstone)',
    zone:   '6b',
    note:   'The Point — where the Allegheny and Monongahela rivers join to form the Ohio — was the most strategically contested site in North America before the Revolution. Fort Duquesne (1754) and Fort Pitt (1758) controlled the gateway to the entire Ohio Valley. Pittsburgh\'s 90 bridges over its three rivers make it a city of neighborhoods divided and connected by water.',
  },
  // ── West Virginia (additional) ───────────────────────────────────────────
  {
    ...
    river:  'Kanawha River',
    region: 'valleyRidge',
    soil:   'Gilpin channery silt loam (Appalachian Plateau shale)',
    zone:   '6b',
    note:   'At the confluence of the Elk and Kanawha rivers — the Great Kanawha cuts through the Appalachian Plateau in a series of gorges, dropping 700 feet from the headwaters to the Ohio River. The Kanawha salt works produced salt that preserved meat for the entire Confederate Army; the chemical industry that replaced them still lines the river banks.',
  },
  // ── Tennessee (additional) ───────────────────────────────────────────────
  {
    ...
    river:  'Mississippi River',
    region: 'interiorLowlands',
    soil:   'Memphis silt loam (Loess Hills — deep windblown silt, 100+ ft)',
    zone:   '7b',
    note:   'On the Fourth Chickasaw Bluff — one of the few high points on the lower Mississippi, making it a natural crossing and trading site. The loess bluffs here are 100 feet of windblown glacial silt, among the deepest in North America, creating the distinctive yellow-brown soils of the Mid-South cotton belt.',
  },
  // ── Missouri ─────────────────────────────────────────────────────────────
  {
    name:   'St. Louis',
    ...
    lat:     38.627,
    lon:    -90.197,
    river:  'Mississippi River (Missouri confluence)',
    region: 'interiorLowlands',
    soil:   'Winfield silt loam (loess over Mississippian limestone)',
    zone:   '6b',
    note:   'Gateway Arch marks the starting point of the Lewis and Clark Expedition — where the Missouri River joins the Mississippi in the largest river confluence in North America. Cahokia, just across the river, was the largest pre-Columbian city north of Mexico; at its peak around 1100 CE it was larger than contemporary London.',
  },
  // ── Vermont ──────────────────────────────────────────────────────────────
  {
    name:   'Burlington',
    ...
    lat:     44.479,
    lon:    -73.213,
    river:  'Winooski River / Lake Champlain',
    region: 'neUpland',
    soil:   'Covington silty clay (calcareous Lake Champlain lake-bed sediment)',
    zone:   '5b',
    note:   'Vermont\'s largest city on the eastern shore of Lake Champlain — the lake is the corridor between the St. Lawrence valley and the Hudson, the route of both the Champlain Canal and Revolutionary War campaigns. The clay-rich lakebed soils support the apple orchards that made the Champlain Valley Vermont\'s most productive farmland.',
  },
  // ── New York (additional) ─────────────────────────────────────────────────
  {
    name:   'Albany',
    ...
    lat:     42.651,
    lon:    -73.754,
    river:  'Hudson River / Mohawk River',
    region: 'neUpland',
    soil:   'Elnora loamy fine sand (glacial outwash over lacustrine sediment)',
    zone:   '6a',
    note:   'Where the Mohawk River joins the Hudson — the Erie Canal\'s eastern terminus connected the Great Lakes to New York Harbor through this valley in 1825, making Albany the pivot of the entire continental interior\'s westward trade. The Hudson Valley soils here record thousands of years of glacial lake varve deposits.',
  },
  // ── Wisconsin (additional) ───────────────────────────────────────────────
  {
    ...
    lat:     43.074,
    lon:    -89.384,
    river:  'Yahara River / Four Lakes',
    region: 'greatLakes',
    soil:   'Plano silt loam (loess over calcareous glacial till)',
    zone:   '5a',
    note:   'Built on an isthmus between Lake Mendota and Lake Monona — the Four Lakes were created by glacial moraines damming the Yahara River drainage. University of Wisconsin\'s agricultural research station here pioneered scientific dairying; the campus grounds grow some of the finest prairie restorations in the Midwest.',
  },
  // ── Minnesota ─────────────────────────────────────────────────────────────
  {
    name:   'Duluth',
    ...
    lat:     46.782,
    lon:    -92.107,
    river:  'St. Louis River / Lake Superior',
    region: 'greatLakes',
    soil:   'Omega loamy fine sand (outwash over Superior lobe glacial till)',
    zone:   '4b',
    note:   'At the western tip of Lake Superior — the largest freshwater lake in the world by surface area. Duluth–Superior harbor handles more cargo than any port on the Great Lakes; the ore boats carry taconite iron pellets from the Iron Range to Chicago and Detroit steel mills via the Soo Locks. The boreal forest begins just north of the city.',
  },
  // ── Michigan (additional) ─────────────────────────────────────────────────
  {
    ...
    region: 'greatLakes',
    soil:   'Amadon loam (thin till over Niagaran limestone)',
    zone:   '5a',
    note:   'The Soo Locks bypass a 21-foot drop in the St. Marys River connecting Lakes Superior and Huron — the busiest lock system in the world by tonnage. The oldest American city in the Midwest (1668 French mission); iron ore from the Marquette Range was first shipped through here in 1855.',
  },
  {
    name:   'Traverse City',
    state:  'MI',
    lat:     44.763,
    lon:    -85.620,
    river:  'Boardman River / Grand Traverse Bay',
    region: 'greatLakes',
    soil:   'Kalkaska loamy sand (sandy glacial outwash, well-drained)',
    zone:   '6a',
    note:   'Cherry capital of the world — the thermal moderation of Grand Traverse Bay delays spring frosts and advances fall frosts, creating a perfect microclimate for tart cherries and wine grapes on the Old Mission Peninsula. The well-drained Kalkaska sands warm quickly in spring, the defining feature of Michigan\'s fruit belt.',
  },
];
